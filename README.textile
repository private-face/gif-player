...
* @horizontalClass {'gp-horizontal'}@ — This class is set if the animated GIF takes this 100% of screen *width* in fullscreen mode.
* @verticalClass {'gp-vertical'}@ — This class is set if the animated GIF takes this 100% of screen *height* in fullscreen mode.
